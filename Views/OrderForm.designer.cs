...
namespace SelfDC
{
    partial class OrderForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.Windows.Forms.MenuItem mnuEdit;
            ...
            // mnuFile
            // 
            mnuFile.MenuItems.Add(mnuExport);
            mnuFile.Text = "Ordine";
            // 
            // mnuExport
            // 
            mnuExport.Text = "Esporta";
            mnuExport.Click += new System.EventHandler(this.actExport);
            // 
            // mnuEdit
            // 
            mnuEdit.MenuItems.Add(this.mnuRemove);
            mnuEdit.MenuItems.Add(this.menuItem8);
            mnuEdit.MenuItems.Add(this.mnuRemoveAll);
            mnuEdit.Text = "Modifica";
            // 
            // mnuRemove
            // 
            ...
            this.bcReader.GoodReadEvent += new System.EventHandler(this.OnBarcodeScan);
            this.bcReader.OnStatus += new System.EventHandler(this.bcReader_OnStatus);
            this.bcReader.OnEngineStart += new System.EventHandler(this.bcReader_OnEngineStart);
            this.bcReader.OnEngineStop += new System.EventHandler(this.bcReader_OnEngineStop);
#else
            this.bcReader.ScannerEnabled = false;
            this.bcReader.GoodReadEvent += new  ScannerEngine.LaserEventHandler(this.GoodReadEvent);
#endif
            // 
            // OrderForm
            // 
